...
For common parlance let’s define what a sigil is: the encoding of desire or intent into a symbol. The Latin sigillum, means ‘seal’, though it may also be related to the Hebrewהלוגס  (segula meaning ‘word, action, or talisman’). A few examples of sigils are Johannes Trithemius’ experiments in ‘Steganographia’, Giordano Bruno’s mnemonic devices, and John Dee’s Sigillum Dei Aemaeth.
